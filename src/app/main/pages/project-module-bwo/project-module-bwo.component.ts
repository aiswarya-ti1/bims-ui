...
@Component({
    selector     : 'project-module-bwo',
    templateUrl  : './project-module-bwo.component.html',
    styleUrls    : ['./project-module-bwo.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : fuseAnimations
})
export class ProjectModuleBWOComponent
{  
